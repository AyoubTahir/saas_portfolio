        ...
        <div class="page-title">
            ...
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    ...
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Services Section</a> </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row" id="cancel-row" style="{{ $service != '' ? '' : 'display: none' }}">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12 col-12 d-flex align-items-center justify-content-end">
                        <button id="openModal" class="btn btn-success btn-lg mr-3" data-toggle="modal" data-target="#addservice">
            ...
            <div class="widget-content widget-content-area pb-0">
                <div class="table-responsive mb-4">
                    <form id="table-form" action="{{ route('home.services.destroy') }}" method="POST">
                        <table class="table table-bordered mb-4">
                            ...
                            <tbody>
                                @if ($service && $service->servicesfield)
                                    @foreach ( $service->servicesfield as $field )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown custom-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                    <a class="dropdown-item" href="{{ route('home.services.edit',$field->id) }}">Edit</a>
                                                    <a class="dropdown-item" href="javascript:void(0);" onclick="deleteTable('delete-field-{{ $field->id }}-form')">Delete</a>
                                                    <form id="delete-field-{{ $field->id }}-form" action="{{ route('home.services.delete',$field->id) }}" method="POST" class="d-none">
                                                        @csrf
                                                    </form>
                                                </div>
                                            </div>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
        <form class="general-info" method="POST" action="{{ route('home.services.updatesection') }}" enctype="multipart/form-data">
            @csrf
            <div class="info">
                <h6 class="mt-4">Services Section Information</h6>
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ar" value="{{$service &&  $service->title_ar ? $service->title_ar : '' }}" class="form-control {{ $errors->has('title_ar') ? 'mb-1' : 'mb-4'}}" id="title-ar">
                                        @error('title_ar')
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" value="{{ $service && $service->title_en ? $service->title_en : '' }}" class="form-control {{ $errors->has('title_en') ? 'mb-1' : 'mb-4'}}" id="title-en">
                                        @error('title_en')
                                            @if (old('is_modal') != 'yes_modal')
                                            <span class="invalid-feedback" style="display: inline-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_ar" class="form-control {{ $errors->has('description_ar') ? 'mb-1' : 'mb-4'}}" id="description-ar">
                                            {{$service &&  $service->description_ar ? $service->description_ar : '' }}
                                        </textarea>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_en" class="form-control {{ $errors->has('description_en') ? 'mb-1' : 'mb-4'}}" id="description-en">
                                            {{ $service && $service->description_en ? $service->description_en : '' }}
                                        </textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option {{ $service && $service->status == 1 ? 'selected' : '' }} value="1">Active</option>
                                            <option {{ $service && $service->status == 0 ? 'selected' : '' }} value="0">Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" style="display: inline-block" role="alert">
                                                <strong>{{ $message }}</strong>
...
<div class="modal fade" id="addservice" tabindex="-1" role="dialog" aria-labelledby="addserviceLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ route('home.services.store') }}">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="formInputModalLabel">Add New service</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="name-ar">Arabic service name</label>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="name-en">English service name</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="desc-ar">Arabic service Description</label>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="desc-en">English service Description</label>
